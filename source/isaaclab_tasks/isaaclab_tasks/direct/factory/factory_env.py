...
class FactoryEnv(DirectRLEnv):
    ...
    def _get_curr_successes(self, success_threshold, check_rot=False):
        ...
        elif self.cfg_task.name == "stacker_insert":
            # For stacker insert, use the base height as the insertion depth threshold
            height_threshold = fixed_cfg.base_height * success_threshold
        else:
    ...
    def step_sim_no_action(self, render: bool = False):
        ...
        if render and (self.sim.has_gui() or self.sim.has_rtx_sensors()):
            self.sim.render()
