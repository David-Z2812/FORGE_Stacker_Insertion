...
from .forge_tasks_cfg import ForgeGearMesh, ForgeNutThread, ForgePegInsert, ForgeStackerInsert, ForgeTask
...
class ForgeObsRandCfg(ObsRandCfg):
    ...
    fingertip_rot_deg = 0.0  # No rotation noise for deterministic behavior
    ft_force = 1.0
