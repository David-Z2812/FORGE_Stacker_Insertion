#!/usr/bin/env python3
"""
Visualize Forge Stacker Insert environment without physics requirements.
"""
...
def main():
    print("🎬 Loading Forge Stacker Insert Environment (Visualization Mode)...")
    ...
    try:
        ...
        # Modify the configuration to disable contact sensors for visualization
        print("Disabling contact sensors for visualization...")
        cfg.task.fixed_asset.spawn.activate_contact_sensors = False
        cfg.task.held_asset.spawn.activate_contact_sensors = False
        print("✅ Contact sensors disabled")
        ...
        print(f"   - Contact sensors: DISABLED (visualization mode)")
        ...
        print("   - Note: This is visualization mode (no physics simulation)")
